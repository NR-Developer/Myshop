...
public class Category_Content extends RecyclerView.Adapter<Category_Content.Holder> {
    private List<CategoryMode> sliders;
    private Activity activity;
    private ImageLoader imageLoader = ImageLoader.getInstance();

    public Category_Content(List<CategoryMode> sliders, Activity activity) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.content_category, parent, false);
...
//        CircleImageView mCircleImageView;
        ...
        Holder(final View itemView) {
            super(itemView);
            title = itemView.findViewById(R.id.mTextContentCategory);
